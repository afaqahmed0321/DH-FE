...
function PaymentTable() {
  ...
  const data = Object.keys(managers).length > 0 && managers?.managers.length > 0 ? managers.managers : [];
            ...
            <tr key={index} className="pt-3">
              <td>
                <div className="d-flex align-items-center w-25 h-25">
                  <Image src={`${process.env.REACT_APP_SERVER_URL}${item.photo}`} className="table-pic-size"/>
