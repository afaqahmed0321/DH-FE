...
const HorizontalCard = (props) => {
  return (
    <div className="horizontal-card d-flex flex-column flex-md-column flex-xl-row " onClick={() => props.spaceClickHandler(props.id)}>
      <div className=" position-relative w-custom">
      ...
      <div className="p-3">
        <div className="">
          ...
          <div className="address pt-3 grey text-14">
