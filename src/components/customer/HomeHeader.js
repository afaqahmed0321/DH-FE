...
import filterBlue from "../../assets/images/icons/customer-filter.svg";
import SpacesIcon from "../../assets/images/icons/Spaces";
import CustomerGrid from "../../assets/images/icons/customerGrid";
import CustomerMapview from "../../assets/images/icons/customerMapview";
import CustomModal1 from "../../shared/CustomModal1";
import CustomerHomeFilterForm from "./filterForm";
import "../../assets/css/home.css";
import "../../assets/css/radio.css";
import { useSelector, useDispatch } from "react-redux";
import { getFilteredCategories, getAllSpaces, getAreaSpace } from "../../store/storeIndex";
import GooglePlacesAutocomplete from 'react-google-places-autocomplete';

export default function CustomerHomeHeader({ view, setView }) {
  ...
  const filterSpaceHandler = (filterBy) => {
    ...
    if (filterBy === "all") {
      dispatch(getAllSpaces(token, 1));
    } else {
      dispatch(getAllSpaces(token, 1, filterBy));
    }
  };
  ...
  return (
    <div className="main mt-3 mb-4">
        ...
        <Col md="7" xl="6" className="pe-0 ps-sm-3 ps-0">
          <div className="d-flex align-items-center justify-content-end gap-3">
            ...
            <div className="d-flex align-items-center min-w-max-content">
              ...
              >
                <Image alt="gallery" src={filterBlue} />
                Filter
              </Button>
            </div>
          </div>
      ...
      <Row className="mt-3 d-flex justify-content-between w-100 pe-0 gap-md-0 gap-2 align-items-start mx-0">
        <Col md="5" xl="8" className="ps-0">
          <div className=" hideOnSmall">
            <div className="d-flex align-items-center gap-3 space-type">
            ...
            <div className="d-flex align-items-center w-100 pe-sm-3">
              {Object.keys(filterableCategories).length > 0 && (
                <div className="d-flex align-items-center justify-content-start w-100">
                  <Form.Label className="min-w-100 mb-0">
                    Select Type: &nbsp;
                  </Form.Label>
                  <Form.Select
        ...
        <Col
          md="7"
          xl="4"
          className="pe-0 ps-md-3 pt-md-0 pt-4 ps-0 cutomer-home "
        >
