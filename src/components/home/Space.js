...
const CardComponent = ({ onClick, ...props }) => {
  ...
  const handleClick = (value) => {
    ...
    dispatch(changeAvailability(userId, data, token));
  };
  return (
    <SpaceCard>
      <div
      ...
      >               
        <Image
          src={props.src}    
          className="img-rounded custom-rounded main-card-img w-100"
          fluid
        />
      ...
      <div className="ps-3 pe-2 card-container ">
        <div className="text-18 fw-bolder pt-3 custom-lineheight cut-text">
          {props.title}
        </div>

        <Row className="mt-sm-2">
          <Col sm="6" className="pe-0">
            <div className="phone pt-2 grey text-14">
              <Image alt="gallery" src={phone} className=" pe-2" />
              {props.phone}
            </div>
          </Col>
          <Col sm="6" className="pe-0 custom-mt-capacityaction">
            <div className="capacity pt-2 grey text-14">
        ...
        <Row className="mt-sm-2">
          <Col sm="6" className="pe-0  cut-text">
            <div className="type grey pt-2 text-14 ">
              <Image alt="gallery" src={space} className=" pe-2" />
              Type: <span className="text-grey text-14">{props.type}</span>
            </div>
          </Col>
          <Col className="pe-0 custom-mt-rate">
            <div className="rate grey text-14 ">
        ...
        <div className="address pt-1 grey text-14 custom-lineheight mt-sm-2">
