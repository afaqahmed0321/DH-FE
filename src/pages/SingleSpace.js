...
import MainHeader from "../components/singleSpace/MainHeader";
import { MainCardCompnent } from "../components/singleSpace/Main";
...
const SingleSpace = () => {
  ...
  return (
    <MainLayout>
      <Container fluid>
        <MainHeader heading="My Spaces / " highlight={singleSpace?.description || ''} class="fst-italic font-grey " />
        <MainCardCompnent icon1={electric1} icon2={electric2} icon3={electric3} icon4={electric4} />
        <Reviews />
      </Container>
    </MainLayout>
  );
